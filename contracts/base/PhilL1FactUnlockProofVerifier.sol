...
import {IPhilL1ProofInputHashAnchor} from "./interfaces/IPhilL1ProofInputHashAnchor.sol";
import {PhilAuthorizationHashing} from "./PhilAuthorizationHashing.sol";

contract PhilL1FactUnlockProofVerifier is IPhilUnlockProofVerifier {
    ...
    constructor(address trustAnchor_) {
        ...
        returns (bool)
    {
        ...
        return trustAnchor.anchoredProofInputHashFact(factHigh, factLow);
    }
