...
use crate::BaseField;
use crate::fields::m31::{M31, M31Trait, M31Zero};
...
fn finalize_m31_hash(state: Blake2sState, byte_count: u32, msg: Box<[u32; 16]>) -> Blake2sHash {
    Blake2sHash { hash: reduce_blake2s_words(blake2s_finalize(:state, :byte_count, :msg)) }
}
...
pub impl Blake2sMerkleHasher of MerkleHasher {
    ...
    fn hash_node(
        ...
        if column_values.is_empty() {
            ...
            return finalize_m31_hash(state, byte_count, msg);
        }
        ...
        finalize_m31_hash(state, byte_count, msg)
    }
}
