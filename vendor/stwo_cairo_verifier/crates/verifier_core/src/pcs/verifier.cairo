...
///
/// Phil's authentic STWO proofs currently use the Rust default `pow_bits = 10`, so the Cairo
/// verifier must match that verifier-side acceptance threshold for parity.
...
/// - `[oods_point - g, oods_point, oods_point + g]`
